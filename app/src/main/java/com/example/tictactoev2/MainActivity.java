...
public class MainActivity extends AppCompatActivity {
    ...
    public void check(View view) {
        Button button_current = (Button) view;
        if (button_current.getText().toString().equals("")) {
            count++;
            if (flag == 0) {
                button_current.setText("X");
                flag = 1;
            } else {
                button_current.setText("O");
                flag = 0;
            }
            if (count > 4) {
                ...
                } else if (b1.equals(b7) && b4.equals(b7) && !b1.equals("")) {
                    Toast.makeText(this, "Winner is : " + b1, Toast.LENGTH_SHORT).show();
                    new_game();
